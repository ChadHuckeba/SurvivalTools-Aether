...
## Overview
Aether uses a professional telemetry stack to ensure that all background activities are auditable. This system is managed by the **Cairn Logging Authority**.
